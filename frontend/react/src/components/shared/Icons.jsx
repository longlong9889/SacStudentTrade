...
export function HeartIcon({ filled, size = 18 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill={filled ? "#C44536" : "none"} stroke={filled ? "#C44536" : "currentColor"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function TagIcon({ size = 12 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round">
...
export function CheckCheckIcon({ read, size = 14 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={read ? "#2D6A4F" : "#B5B0AA"} strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
      <polyline points="18 6 9 17 4 12"/><polyline points="22 6 13 17" opacity="0.5"/>
    </svg>
  );
}
